    ...
    <div className="min-h-screen bg-[#0F1115] text-slate-200 flex flex-col font-sans">
      <header className="p-8 flex items-center justify-between border-b border-white/5 bg-[#16191E]/50 backdrop-blur-xl sticky top-0 z-50">
        <div className="flex items-center gap-4">
          <div className="w-11 h-11 bg-[#00D9FF] rounded-2xl flex items-center justify-center">
            <Shield size={26} className="text-[#0F1115]" />
          </div>
          <div>
            <h1 className="text-xl font-black tracking-tighter text-white uppercase leading-none">RPR-KONTROL</h1>
            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.3em] mt-1.5">Governance Tower</p>
          </div>
        </div>
